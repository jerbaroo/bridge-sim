...
*** TODO Stress/Strain TCL file
*** TODO Ask about VPN login
*** TODO AxisVM pier displacement
*** TODO Temperature load
*** TODO Mean in convergence plot
- Calculating over a grid makes sense
- Because additional nodes near the point load will influence the mean
*** TODO OpenSees in parallel
*** TODO Single section takes a lot longer?
*** TODO Axis: Look at pier displacement I messed up
*** TODO Go over fixed nodes in TCL & in Axis
*** TODO Go over
* Week's work
** 7th October
