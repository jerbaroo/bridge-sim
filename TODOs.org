...
- TrafficSequence (low memory)
- Traffic (natural semantics)
- TrafficArray (numpy array)
- Creation of traffic array not so fast (consider Hz)
- Calculation of responses very fast
