...
- Running simulation for each pier under unit displacement
- Need to calculate response due to varied pier displacement
*** TODO Responses via matrix multiplication
*** TODO Collect responses under different scenarios at different points
*** TODO Unit load plot
*** TODO Quantify difference in responses
*** TODO Convergence plot
*** TODO Talk about what to store in terms of traffic & responses
*** TODO How to argue any value of 2D model
*** TODO Look at numba
* Week's work
** 7th October
...
*** Faster generation of responses to traffic [0/4]
**** TODO Contour plots of verification points on workhorse
**** TODO Traffic as numpy array
**** TODO Influence line responses as numpy array
**** TODO Linear algebra
