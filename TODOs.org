...
* Safe List
** TODO Rigid links experiment :axis:local:
** TODO Distributed load experiment :axis:local:
** TODO Publish on Pypi :software:local:
- Write about the interface
** TODO Validated strain :validation:
- Check strain at radii
** TODO Validated pier displacement :validation:
** TODO Literature review submitted :writing:
...
** TODO Comparison of 2D and 3D data :software:
** TODO Validated thermal load :validation:
** TODO Noise :parameters:local:
- reference value from bridge 705
- method of scaling noise per sensor
** TODO Light vehicles :parameters:local:
** TODO ULS experiment :parameters:local:
** TODO Correlation with temperature :plot:temperature:
** TODO Sensor positions with PSO :classifier:local:
** TODO Sensor positions on second bridge :classifier:local:
** TODO Plot of each loading type :plot:validation:
** TODO Plot of a pier :plot:local:
