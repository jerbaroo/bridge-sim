...
* Safe List
** ABORT Rigid links experiment :axis:local:
CLOSED: [2020-01-16 Thu 10:55]
** ABORT Distributed load experiment :axis:local:
CLOSED: [2020-01-16 Thu 10:55]
** TODO Publish on Pypi :software:local:
- Write about the interface
** TODO Validated strain [0/3] :validation:
*** TODO Check strain at radius of point A
*** TODO Check strain at radius of points B - D
*** TODO
** TODO Validated pier displacement :validation:
*** TODO Show convergence without
** TODO Literature review submitted [0/3] :writing:
*** TODO Address Arpi's feedback
*** TODO Address peer feedback
*** TODO Write about anomaly detection
** TODO First classifier :classifier:
*** TODO Collect data, before strain validation
** TODO Write about density :writing:
- Density should have no affect.
- Write about affect of density for Monday.
** TODO Comparison with real time series :validation:
*** TODO Meeting with Arthur to go over Matlab script
** WAIT Comparison of 2D and 3D data :software:
** TODO Validated thermal load :validation:
** TODO Noise :parameters:local:
- reference value from bridge 705
*** TODO Set noise based on stddev method in paper
** TODO Light vehicles :parameters:local:
*** TODO Find paper from TNO
*** TODO Add vehicles per class
** DONE ULS experiment :parameters:local:
CLOSED: [2020-01-16 Thu 10:58]
** TODO Plot annual temperature effect :plot:temperature:
** TODO Plot of each loading type :plot:validation:
** WAIT Mesh refinement
** DONE Validated Displacement
...
** January 16
- Submit literature review tonight
...
- For next Friday:
  ...
  - focus on
    ...
    - collect data
    - remainder of plots
      - thermal loading validation
      - annual effect of temperature
      - traffic: light vehicles
      - traffic: top view of bridge
      - time series: comparison to measurements
      - time series: events
      - show area sensors can't be placed
* Todos
** TODO <2020-01-09 Thu> [0/5]
*** TODO 250 words
*** TODO Arpi meeting
*** TODO Pier validation plots
*** TODO Collect strain at multiple radii
*** TODO Start thermal correlation plot
