...
- Switching off interpolation seems to have fixed some jaggedness. Just to sort
  out strain now.
** TODO [#A] Traffic top view plot
** TODO [#A] Classify damage
** TODO [#A] Truck 1 time series plots [5/7]
...
** TODO [#B] Send methods section for review
*** TODO Write about density
** TODO [#B] Light vehicles
- Based on  paper from TNO
- Add vehicles per class
** TODO [#B] Temperature gradient references
** TODO [#B] Sub-question A
** TODO [#B] Add README to project
** TODO [#C] Improve cracked concrete model
** TODO [#C] Improve pier settlement model
- Henco's suggestion
...
** TODO [#C] Check linear assumption
...
** TODO Investigate interpolation
- Truck 1 time series should not error with interpolation.
*** TODO Check if
** TODO Calculate ULM in parallel
