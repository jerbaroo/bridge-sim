#+TODO: TODO(t) INPROGRESS(i) FEEDBACK(f) VERIFY(v) WAIT(w) BLOCKED(b) | DONE(d) ABORT(a) LATE(l)
...
*** TODO Verify deck sections
*** TODO Print correct section in cloud of Nodes plot
*** TODO Plots of PS from Diana
*** TODO Plots of PS from OpenSees
