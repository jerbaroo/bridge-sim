...
*** TODO Section order in generated TCL file is not deterministic.
I don't think this this is an issue because each line was the same as before,
the lines were simply in different places.
*** TODO Large refactor of vehicles and loads.
*** TODO Load an ILMatrix per position in transverse direction e.g. per wheel track.
* Weeks work
** 7th October
