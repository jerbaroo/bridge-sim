...
selected sensors on bridge 705 be predicted after temperature effect removal
using regression of the model's previous year's (2018) vertical translation
responses with air temperature to remove the annual component and taking hourly
samples to remove the daily component? Furthermore, how does the addition of a
$1 mm$ pier settlement term into the recorded vertical translation responses
from 2018 affect the ability to predict vertical translation?
...
dataset, using air temperature and solar radiation.
and \textcolor{red}{TODO add wind speed for increased daily error, I have the
data}.
...
So far the question has assumed that bridge 705 was in perfect health throughout
2018 when the reference measurements were taken. While it is informative to
investigate this ideal case, it is entirely possible that some pier settlement
has already occured in 2018. So we introduce $1 mm$ of pier settlement that
increases linearly over the period of 2018, to see how the ability to predict
pier settlement is affected.
...
mm$ or 39% of the ground truth, to $0.04 mm$ or 9% when the median over a 2 week
